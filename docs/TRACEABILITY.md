...
| Jobs/Queue/Submit/detail | Form, priority, reason, Assignment/events, stop/cancel | src/app/(console)/workloads; queue; components/workloads | 9 contract tests; Playwright create→run→stop |
